...
{
	const ProtozoaTracker& protozoa = snapshot.protozoa_tracker;
...
void World::draw_cell_outlines(const ProtozoaTracker& protozoa)
{
...
void World::nearby_food_information(const ProtozoaTracker& protozoa) const
{
...
void World::draw_cell_physical_information(const ProtozoaTracker& protozoa, Font* font) const
{
...
void World::draw_springs(const ProtozoaTracker& protozoa, const bool thick_lines) const
{
...
int World::check_mouse_press(const ProtozoaTracker& protozoa, const sf::Vector2f mousePosition, const bool tolerance_check) const
{
    for (const Cell& cell : protozoa.cells)
    {
...
const Cell* World::get_selected_cell(const ProtozoaTracker& protozoa, const sf::Vector2f mouse_pos)
{
